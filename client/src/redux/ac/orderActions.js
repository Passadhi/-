...
export const addOrderDb= (inputVol, inputWidth,
  ...
  const response = await axios.post("http://130.193.52.245:3032/upload", newOrder);
  console.log('2')
...
export const getOneOrder = (order) => ({
  ...
  export const getOneOrderFromServer = (id) => async(dispatch) => {
    console.log('ia rabotaiu')
      const response = await axios(`http://130.193.52.245:3032/orders/${id}`)
  ...
  async(dispatch) => {const response = await axios("http://130.193.52.245:3032/activeOrders")
  ...
  async(dispatch) => {const response = await axios("http://130.193.52.245:3032/clientOrders")
  ...
  async(dispatch) => {const response = await axios("http://130.193.52.245:3032/driverOrders")
  console.log('!!!!!!!!!!!!!!!',response.data)
  ...
  export const changeStatusDb=(id)=> async (dispatch) => {
   await axios.patch (`http://130.193.52.245:3032/changeStatus/${id}`) 
